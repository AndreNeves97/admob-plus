...
var Interstitial = /** @class */ (function (_super) {
    ...
    Interstitial.prototype.isLoaded = function () {
        return base_1.execAsync(base_1.NativeActions.interstitial_is_loaded, [{ id: AD_ID }]);
    };
    Interstitial.prototype.load = function (opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, base_1.execAsync(base_1.NativeActions.interstitial_load, [
                            __assign(__assign({}, opts), { adUnitID: this.resolveAdUnitID(opts.id), id: AD_ID }),
                        ])];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, base_1.waitEvent(base_1.Events.interstitial_load, base_1.Events.interstitial_load_fail)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Interstitial.prototype.show = function () {
        return base_1.execAsync(base_1.NativeActions.interstitial_show, [{ id: AD_ID }]);
    };
    return Interstitial;
}(base_1.AdBase));
