...
var RewardVideo = /** @class */ (function (_super) {
    ...
    RewardVideo.prototype.isReady = function () {
        return base_1.execAsync(base_1.NativeActions.reward_video_is_ready, [{ id: AD_ID }]);
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, base_1.execAsync(base_1.NativeActions.reward_video_load, [
                                __assign(__assign({}, opts), { adUnitID: adUnitID, id: AD_ID }),
                            ])];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, base_1.waitEvent(base_1.Events.reward_video_load, base_1.Events.reward_video_load_fail)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RewardVideo.prototype.show = function () {
        return base_1.execAsync(base_1.NativeActions.reward_video_show, [{ id: AD_ID }]);
    };
    return RewardVideo;
}(base_1.AdBase));
